...
Start on **Overview** for three things: “Who’s ready to rumble?” (roster health), this week’s matchup scorecard with both team names and actual/live projected points, and the weekly commentary. Health counts and player names open their dossiers. The lineup and kickoff links take you to the detailed decisions. A dash means a score or forecast is unavailable, never zero.
